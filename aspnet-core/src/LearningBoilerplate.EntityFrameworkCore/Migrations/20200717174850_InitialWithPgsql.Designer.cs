...
{
    [DbContext(typeof(LearningBoilerplateDbContext))]
    [Migration("20200717174850_InitialWithPgsql")]
    partial class InitialWithPgsql
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningBoilerplate.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LearningBoilerplate.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LearningBoilerplate.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LearningBoilerplate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LearningBoilerplate.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LearningBoilerplate.Authorization.Roles.Role", b =>
                {
                    b.HasOne("LearningBoilerplate.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("LearningBoilerplate.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("LearningBoilerplate.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
