...
{
    public abstract class LearningBoilerplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LearningBoilerplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LearningBoilerplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LearningBoilerplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LearningBoilerplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LearningBoilerplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LearningBoilerplateDbContext, Task<T>> func)
        {
            T result;
